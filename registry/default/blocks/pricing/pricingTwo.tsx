                ...
                <div className="mx-auto mt-12 md:mt-20">
                    <div className="w-full px-4 py-8">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="rounded-3xl bg-neutral-900 p-8 ring-1 ring-neutral-700">
                                <div className="flex flex-col h-full">
                                    <div className="mb-8">
                                        <div className="inline-flex items-center font-bold justify-center p-2 rounded-[10px] border border-[rgba(62,62,64,0.77)] bg-[rgba(255,255,255,0)]">
                                            <h3 className="text-sm text-white">Basic</h3>
                                        </div>
                                        <div>
                                            <p className="text-md text-neutral-400 my-4">Try For Free</p>
                                        </div>
                                        <div className="mt-4">
                                    ...
                                    <div className="space-y-4 mb-8">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-sm text-neutral-300">
                                                Limited programs (updated monthly)
                                            </span>
                                        </div>
                                        <div className="flex items-center gap-3">
                                            <svg
                            ...
                            <div className="rounded-3xl bg-neutral-900 p-8 ring-1 ring-neutral-700">
                                ...
                                <div className="flex flex-col h-full">
                                    <div className="mb-8">
                                        <div className="inline-flex items-center font-bold justify-center p-2 rounded-[10px] border border-[rgba(62,62,64,0.77)] bg-[rgba(255,255,255,0)]">
                                            <h3 className="text-sm text-white">Pro ✦</h3>
                                        </div>
                                        <div>
                                            <p className="text-md text-neutral-400 my-4">Lifetime Deal</p>
                                        </div>
                                        <div className="mt-4">
                                    ...
                                    <div className="mt-auto">
                                        <a className="px-4 text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-flex items-center justify-center border-[0.6px] border-solid [border-image-source:linear-gradient(180deg,#1F1F1F_0%,#858585_100%),linear-gradient(180deg,#1F1F1F_0%,#858585_100%)] [background:linear-gradient(0deg,#151515,#151515),linear-gradient(180deg,rgba(21,21,21,0)_66.3%,rgba(255,255,255,0.5)_100%),linear-gradient(183.22deg,rgba(255,255,255,0.5)_2.62%,rgba(21,21,21,0)_52.03%)] shadow-[inset_0px_6px_8px_0px_#FAFAFA40,inset_0px_-6px_8px_0px_#FAFAFA40,0px_0px_0px_0px_#FAFAFA40,0px_0px_0px_0px_#FAFAFA40] text-white 0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08), w-full py-3 rounded-xl !bg-[linear-gradient(180deg,#B6B6B6_0%,#313131_100%)] hover:shadow-[0_4px_12px_0px_rgba(0,0,0,0.4)]">
                            ...
                            <div className="rounded-3xl bg-neutral-900 p-8 ring-1 ring-neutral-700">
                                <div className="flex flex-col h-full">
                                    <div className="mb-8">
                                        ...
                                        <div>
                                            <p className="text-md text-neutral-400 my-4">1 Year Access</p>
                                        </div>
                                        <div className="mt-4">
                                            <span className="text-neutral-500 line-through mr-2">
                                                $179
