...
import { ComponentDataType, ComponentsData } from "@/data/componentsData";
  ...
  return (
    <>
      <div className="px-4 max-w-7xl mx-auto">
        <div className="pt-10 pb-0 flex justify-start relative z-40 gap-3">
          <Link
            href="/blocks"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-20 lg:gap-10 pb-40 items-start relative z-40">
          {ComponentsData.map((component: ComponentDataType) => (
            <Link
              key={component.name}
